...
# 밸런스: cringe_level + volume_req = 150 (데미지 계산에 사용되는 두 스탯의 합 고정)
# precision은 UI 표시용으로만 사용
CHARACTERS = [
    Character(
        id="char_000",
        name="찐따 오타쿠 쿠로",
    ...
    Character(
        ...
        stats=CharacterStats(cringe_level=70, volume_req=95, precision=65),  # 150
    ...
    Character(
        ...
        stats=CharacterStats(cringe_level=100, volume_req=60, precision=85),  # 150
    ...
    Character(
        ...
        stats=CharacterStats(cringe_level=100, volume_req=100, precision=70),  # 150
